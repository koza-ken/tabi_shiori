...
RUN apt-get update -qq && \
    apt-get install --no-install-recommends -y build-essential git libpq-dev pkg-config ca-certificates curl gnupg && \
    rm -rf /var/lib/apt/lists /var/cache/apt/archives

# Install Node.js and Yarn for JavaScript bundling
